...
from services.admin.waivers import list_pilot_waivers, generate_pilot_waiver, send_pilot_waiver, reset_pilot_waiver, create_pilot_waiver
from models import PilotWaiver, Project
...
def init_waivers_routes(app):
    ...
    def admin_pilot_waiver_new():
        ...
        # List projects that don't have a waiver yet
        ...
        return render_template("admin/pilot_waiver_form.html", projects=available_projects)
