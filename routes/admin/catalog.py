from flask import render_template, Response, current_app, redirect, url_for, flash, send_from_directory
from utils.decorators import require_roles
from services.admin.catalog import get_catalog_data, generate_catalog_pdf, update_stored_catalog
import os
