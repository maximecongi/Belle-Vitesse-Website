...
from models import AppSetting, McpApiToken
from utils.decorators import require_roles

settings_bp = Blueprint('admin_settings', __name__, url_prefix='/admin/settings')

# Configuration déclarative des paramètres de l'application
SETTING_KEYS = [
...
def admin_settings_edit():
    ...
    # Chargement groupé optimisé avec repli automatique sur les variables d'environnement (.env)
    settings_data = AppSetting.get_all_as_dict({key: '' for key, _, _ in SETTING_KEYS})
