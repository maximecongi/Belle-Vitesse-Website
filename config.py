...
class DevelopmentConfig(Config):
    ...
    # Handle SSH Tunnel in app.py logic, but we can store the base URI here
    # or let app.py override it if tunnel is active.
...
class ProductionConfig(Config):
    ...
    ARCLIGHT_UPLOAD_DIR = Path(os.getenv("ARCLIGHT_UPLOAD_DIR", "/srv/bellevitesse/arclight/videos"))
